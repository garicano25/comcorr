...
export const aprovePedidoService = (id:number) => {
    return new Promise<IResponseEstatusPedido>( async (resolve, reject) => {
      try {
        ...
        const response: AxiosResponse = await clientAdmin.put(`/pedidos/${id}`, {"estado":"aceptado"})
        resolve(response.data);
...
export const declinePedidoService = (id:number) => {
    return new Promise<IResponseEstatusPedido>( async (resolve, reject) => {
      try {
        ...
        const response: AxiosResponse = await clientAdmin.put(`/pedidos/${id}`, {"estado":"rechazado"})
        resolve(response.data);
...
export const getInfoPedido = ({ idPedido } : {idPedido: number}) => {
     return new Promise<IResponseInfoPedido>(async (resolve, reject) => {
        try {
            ...
            const response: AxiosResponse = await clientAdmin.get(`/pedidos/${idPedido}`)
            resolve(response.data);
...
export const changeStatusArtService = (articulo_id: number, estado:string, pedido_id: number) => {

  return new Promise<IResponseEstatusPedido>(async (resolve, reject) => {
    try {
      const response: AxiosResponse = await clientAdmin.put(`/pedidos/${pedido_id}/articulos`, {
